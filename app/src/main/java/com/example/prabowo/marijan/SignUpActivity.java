...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void registerUser() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(com.example.prabowo.marijan.SignUpActivity.this,
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(com.example.prabowo.marijan.SignUpActivity.this, "Registered Succesfull", Toast.LENGTH_SHORT).show();
                            finish();
                            startActivity(new Intent(getApplicationContext(),MainActivity.class).putExtra("namaku",namaku));

                        } else {
                            Log.e("Tag", "onComplete: Failed=" + task.getException().getMessage());
                            Toast.makeText(com.example.prabowo.marijan.SignUpActivity.this, "Registered unsuccesfull", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void onClick(View v) {
        ...
        if (v == TVsignin) {
            startActivity(new Intent(this, com.example.prabowo.marijan.LoginActivity.class));
